...
const Navbar = () => {
    return (
        <div className='flex justify-between items-center px-12 py-4  h-20 rounded-xl w-[98%] mx-auto custom-shadow z-50 sticky top-0 w-sticky bg-white'>
            ...
            <nav>
                <ul className='flex justify-center items-center text-lg font-semibold'>
                    <li className='ml-7'><NavLink to={'/'}>Home</NavLink></li>
                    <li className='ml-7'><NavLink to={'/about'}>About</NavLink></li>
                    <li className='ml-7'><NavLink to={'/services'}>Services</NavLink></li>
                    <li className='ml-7'><NavLink to={'/projects'}>Projects</NavLink></li>
                    <li className='ml-7'><NavLink to={'/contact-me'}>Contact Me</NavLink></li>
                </ul>
            </nav>
            <div>
                <label data-toggle-theme="light, dark" class="swap swap-rotate">
