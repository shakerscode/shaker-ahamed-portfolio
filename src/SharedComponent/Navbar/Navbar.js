    ...
    return (
        <div className='flex justify-between items-center md:px-12 px-5 py-4  h-20 rounded-xl w-[98%] mx-auto custom-shadow z-50 sticky top-0 w-sticky bg-white'>
            ...
            <nav className={open ? 'block' :'hidden'}>
                <ul className=' md:flex md:justify-center md:items-center text-md font-semibold'>
            ...
            <div className='flex justify-center items-center'>
                <a href="#contact">
                    <button className='flex justify-around items-center bg-primary text-white md:px-10 md:py-2 px-4 py-2 text-sm md:text-md rounded-full font-semibold hover:border-2 hover:border-primary hover:bg-white hover:text-black transition-all duration-1000 ease-in-out '>Contact Me<IoSend className='md:ml-3 ml-2'></IoSend>
                    </button>
                </a>
                <label onClick={()=>setOpen(!open)} class="btn btn-circle btn-primary swap swap-rotate md:hidden p-5 ml-4"> 
                    <input type="checkbox" /> 
                    <svg class="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512"><path d="M64,384H448V341.33H64Zm0-106.67H448V234.67H64ZM64,128v42.67H448V128Z" /></svg>
 
                    <svg class="swap-on fill-current" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512"><polygon points="400 145.49 366.51 112 256 222.51 145.49 112 112 145.49 222.51 256 112 366.51 145.49 400 256 289.49 366.51 400 400 366.51 289.49 256 400 145.49" /></svg>
